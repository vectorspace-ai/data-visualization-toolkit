		...
		if len(pmid_list) is not 0:
			...
			for pmid in pmid_list:
				...
				if len(article)>5:
					...
					abstract="\n".join([i for i in article[3:] if AUTHOR_INFO not in i and DOI not in i and COPYRIGHT not in i and AT not in i and EMAIL not in i and PMID_TAG not in i and PMCID not in i])
